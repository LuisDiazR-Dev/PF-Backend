...
const getMetadata = async () => {
  try {
    ...
    return average; // Asegúrate de que averagePrice() devuelva el número esperado
  } catch (error) {
...
const generatePDF = (res, metadata, admins) => {
  ...
  doc
    ...
    .moveDown(2)
    .text('Este informe proporciona un resumen detallado de las ganancias obtenidas durante el mes.', 50, 160);
